CopyOnWrite коллекции удобно использовать, когда в основном происходит чтение и мало записи. Например, удобно для реализации механизма подписка listeners.
